...
Logotipo del 10.º aniversario de Google Classroom con un gorro de fiesta y globos animados
Classroom
Estructura y Programación de Computadoras
Grupo 2. Semestre 2024-I
Inicio
Calendar
Cursos en los que te has inscrito
Tareas pendientes
P
PROPEDÉUTICO GENERAL 2025-1
P
PROPEDÉUTICO TÉCNICO 2025-1
I
...
Gpo: 13 Semestre 2024-1
Clases archivadas
Ajustes
Tu profesor ha archivado la clase. No puedes añadir contenido ni realizar cambios.
Detalles de la tarea
Proyecto - Juego "Galaga"
Luis Sergio Durán
•
9 nov 2023 (Última modificación: 10 dic 2023)
10 puntos
Fecha de entrega: 13 dic 2023, 10:30
Realizar un programa en lenguaje ensamblador para arquitectura Intel x86 que realice aparente un juego "Galaga".

Se deberá ejecutar un programa que simule o aparente un juego "Galaga" (mucho más sencillo que el original) en el que se tiene una figura de una nave en la parte inferior controlada por el usuario y una nave enemiga en la parte superior que es "controlada" por la CPU. El objetivo del juego es que el usuario elimine el mayor número de naves enemigas que aparezcan en pantalla. Para eliminar al enemigo, el usuario puede lanzar proyectiles, pero la nave enemiga también puede lanzar proyectiles para eliminar al usuario. El usuario tendrá un número determinado de intentos (vidas, o lives) para eliminar las naves enemigas. El juego termina cuando el usuario haya agotado sus vidas.

La nave del usuario debe poder desplazarse horizontalmente, izquierda y derecha, utilizando dos teclas distintas en el teclado. La nave enemiga debe desplazarse horizontalmente también, además de hacer movimientos hacia abajo. Los movimientos de la nave enemiga deberán ser automáticos, ya sea aleatorios o bien definidos. Los desplazamientos de las naves no deben exceder el área de juego delimitada por los bordes en la interfaz gráfica. Si la nave enemiga choca con el usuario se considera una vida perdida.

La nave del usuario puede lanzar proyectiles, si un proyectil intercepta una nave enemiga, ésta desaparecerá e incrementará un puntaje (score) del usuario, entonces deberá aparecer otra nave enemiga en la parte superior. El score se acumula a lo largo de una partida, y cuando el usuario pierda sus vidas, se deberá comparar con un puntaje máximo (hi-score); si el score es mayor al hi-score, entonces el primero deberá sustituir al segundo y el usuario podrá volver a iniciar una partida. El hi-score se mantiene durante la corrida* del programa. 
*La corrida del programa será cuando se ejecuta el archivo .exe y una partida se considera el inicio del juego y hasta que el usuario agote sus vidas. Una corrida de programa puede tener varias partidas. 

Dentro de la interfaz gráfica hay tres botones: 
- Play: Para iniciar/reiniciar un juego
- Pausa: Para detener el juego en el estado actual en el que se encuentre
- Stop: Para forzar la detención de un juego y reiniciarlo en una posición inicial.
Los botones deben activarse usando el mouse. Opcionalmente, se pueden asociar a teclas del teclado para mayor comodidad pero esto último no se tomará en cuenta para la calificación, solo si se usa el mouse.
...
Con la entrega del programa, se debe hacer la entrega de un documento que deberá contener lo siguiente:
- Introducción: breve descripción y planteamiento del problema.
- Desarrollo: solución del problema, justificación de la solución y diagrama de flujo. El diagrama no debe ser tan detallado, puede contener bloques que representen procesos de código complejos.
- Conclusiones: individuales (por cada integrante del equipo).

*El formato del nombre de los archivos debe ser el siguiente:
p_(iniciales comenzando por apellido).(extensión)
Por ejemplo, si estos son mis archivos de proyecto, nombraré los archivos utilizando mis iniciales como
ASM: p_dals.asm
EXE: p_dals.exe
PDF: p_dals.pdf
**Cada integrante deberá subir una copia de los archivos correspondientes. También se deberá subir un archivo en texto plano con el nombre de los integrantes del equipo.
...
Luis Sergio Durán10 dic 2023
Hola. Les comento que agregué la rúbrica para que revisen los puntos a evaluar del proyecto. El máximo de calificación a obtener es 12 sobre 10, siempre y cuando todo funcione correctamente. Si tienen alguna duda, me avisan
Tu trabajo
Entregado

Integrantes_Equipo_12.txt
Texto
